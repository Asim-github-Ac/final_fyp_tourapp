      ...
      home: DefaultTabController(
        ...
        child: Scaffold(
          ...
          bottomNavigationBar: Container(
            ...
            child: TabBar(
              labelColor:
              Color.fromARGB(255, 127, 106, 232), //<-- selected text color
              unselectedLabelColor: Colors.white,
              tabs: [
                Tab(
                  icon: ImageIcon(AssetImage("assests/order.png")),
                  text: "Order",
                ),
                Tab(
                  icon: ImageIcon(AssetImage("assests/upload.png")),
                  text: "Upload",
                ),
                Tab(
                  icon: ImageIcon(AssetImage("assests/tours.png")),
                  text: "Tours",
                ),
              ],
            ),
